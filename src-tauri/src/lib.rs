...
pub fn run() {
    ...
    .plugin(tauri_plugin_dialog::init())
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_tmdb_season_details,
            commands::get_config,
            ...
            commands::convert_srt_to_txt,
            commands::convert_subtitle_file,
            commands::uvr::check_uvr_env,
            commands::uvr::install_uvr,
            commands::uvr::run_uvr,
            commands::check_ai_environment,
            commands::install_demucs,
            commands::run_stem_separation,
            commands::merge_audio_stems,
            commands::check_whisper_environment,
